            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required>
                            ...
                            <option value="Female" {{ old('gender', $user->gender) == 'F' ? 'selected' : '' }}>Female</option>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="mobilenumber" name="mobilenumber" class="form-control @error('mobilenumber') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="nominee_name" name="nominee_name" class="form-control @error('nominee_name') is-invalid @enderror"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="relation_user" name="relation_user" class="form-control @error('relation_user') is-invalid @enderror"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="sponsor_id" name="sponsor_id" class="form-control @error('sponsor_id') is-invalid @enderror"
                               value="{{ old('sponsor_id', $user->sponsor_id) }}">
                        @error('sponsor_id')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
